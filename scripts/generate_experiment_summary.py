#!/usr/bin/env python3
"""Generate a markdown summary from experiments/logs JSON files."""
...
def generate_markdown(entries: List[Dict[str, Any]]) -> str:
    ...
    lines.append("")
    lines.append("This file is generated by scripts/generate_experiment_summary.py from experiments/logs/*.json.")
...
def main() -> int:
    ...
    parser.add_argument("--logs-dir", default="experiments/logs", help="Directory containing JSON logs")
    parser.add_argument("--output", default="docs/experiment_log.md", help="Output markdown file")
